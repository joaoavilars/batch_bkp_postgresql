...
IF NOT EXIST !FINAL_BACKUP_DIR! (mkdir !FINAL_BACKUP_DIR!)
pg_dump --host=%HOSTNAME% --port=%DBPORT% --username=%USERDB% --format=%file_format% %other_pg_dump_flags% -f !FINAL_BACKUP_DIR!\%DATABASE%.sql %DATABASE%
if %DAY_OF_WEEK% == %DAY_OF_WEEK_TO_KEEP% (goto WEEK)
goto EOF)
...
pg_dumpall -g --username=%USERDB% -f %FINAL_BACKUP_DIR%\globals.sql %DATABASE%)
 
::::::::::::::::::::::::::::
:::::: FULL BACKUPS ::::::::
::::::::::::::::::::::::::::
if %ENABLE_PLAIN_BACKUPS% == "yes" (
pg_dump --host=%HOSTNAME%  --port=%DBPORT% --username=%USERDB% --format=%PLAIN_BACKUPS_YES% %other_pg_dump_flags% -f %FINAL_BACKUP_DIR%\%DATABASE%_PLAIN.sql %DATABASE%)
